     ...
     <div class="nav-wrapper">
    	...
    	<!--Fim da logo-->
         ...
         <ul class="side-nav" id="menu-mobile">
		  ...
		  while($row_menu = $select_menu->fetch()){
		  ?>
          	 <li id="dados_menu_favicon_mobile"><img src="imagens/img_menu_<?php echo $favicon_mobile;?>.png" class="favicon_menu"/></li>
...
<section class="main_area_user">
	...
	<section id="area_login">
        ...
        <section class="form_login">
            ...
            <form name="formLogin" id="formLogin" method="post" action="paginas_carregamento/login_usuario_juridico.php">
     	<div class="row">
    ...
    <h1 class="titulo">ÁREA DE CADASTRO</h1>
     ...
     <form name="formCadastro_juridico" id="formCadastro_juridico" method="post" action="paginas_carregamento/cadastro_usuario_juridico.php">
     	<div class="row">
        	<label class="campo_form">Razão Social:</label>
            <input type="text" maxlength="100" name="razao_social" id="razao_social" class="form-control" 
            placeholder="Razão Social" onfocus="this.placeholder=''" onblur="this.placeholder='Razão Social'"/>
        </div>
        <div class="row">
        	<label class="campo_form"></label>
            <input type="hidden" name="tipo_user" id="razao_social" class="form-control" value="2"
            placeholder="Razão Social" onfocus="this.placeholder=''" onblur="this.placeholder='Razão Social'"/>
        </div>
        <div class="row">
        	<label class="campo_form">CNPJ:</label>
            <input type="text" name="cnpj_user" id="cnpj_cadastro" class="form-control" 
            placeholder="99.999.999/9999-99" onfocus="this.placeholder=''" onblur="this.placeholder='99.999.999/9999-99'"/>
        </div>
        <div class="row">
